...
describe('Modal Component', () => {
  ...
  it('renders the object name and unit', () => {
    render(
      <Modal object={OBJECT} onClose={vi.fn()} onSubmit={vi.fn()} setMascotState={vi.fn()} />
    );
  ...
  it('calls onClose when the ✕ button is clicked', () => {
    const onClose = vi.fn();
    render(
      <Modal object={OBJECT} onClose={onClose} onSubmit={vi.fn()} setMascotState={vi.fn()} />
    );
  ...
  it('calls onSubmit with correct arguments (including recommendation) on submit', async () => {
    ...
    const onClose = vi.fn();
    render(
      <Modal object={OBJECT} onClose={onClose} onSubmit={onSubmit} setMascotState={vi.fn()} />
    );
  ...
  it('falls back gracefully when Terra API fails', async () => {
    ...
    const onSubmit = vi.fn();
    render(
      <Modal object={OBJECT} onClose={vi.fn()} onSubmit={onSubmit} setMascotState={vi.fn()} />
    );
